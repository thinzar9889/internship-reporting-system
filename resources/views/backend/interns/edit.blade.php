                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="card card-light">
                            <div class="card-header">
                                <h3 class="card-title  col-md-11">Edit Intern</h3>
                                ...
                                @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" placeholder="Enter Phone"  value="{{ old('phone', $intern->phone) }}">
                                            @error('phone')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label" for="profile">Profile <span class="text-danger">*</span></label>
